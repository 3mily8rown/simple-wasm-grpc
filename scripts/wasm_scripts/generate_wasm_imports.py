...
def emit_header(imports, type_sigs, header_path, module, native):
...
def main():
    ...
    p.add_argument("--native", required=True, help="File with native function signatures")
    ...
    emit_header(imps, type_sigs, args.header, args.module, args.native)
